...
<<<<<<< HEAD:blog/src/main/java/solo/blog/controller/v2/LoginController.java
   // @PostMapping("/login")
=======
    //@PostMapping("/login")
>>>>>>> b649d7ce221f93c461f63492856a25dae930a0c8:blog/src/main/java/solo/blog/controller/login/LoginController.java
 ...
 */
    ...
    @PostMapping("/login")
    public String loginFilter(@Valid @ModelAttribute LoginForm form, BindingResult bindingResult, @RequestParam(defaultValue = "/") String redirectURL, HttpServletRequest request) {
        if (bindingResult.hasErrors()) {
            return "login/loginForm";
        }
